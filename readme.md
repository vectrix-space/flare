...
In order to build Flare you simply need to run the `gradle` command. You can find the compiled JAR file in `./flare/build/libs` labeled 'flare-0.2.0.jar'.
...
dependencies {
  compile "space.vectrix.flare:flare:0.2.0"
}
```
