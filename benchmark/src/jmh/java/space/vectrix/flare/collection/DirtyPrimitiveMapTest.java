...
public class DirtyPrimitiveMapTest {
  ...
  public void randomWrite() {
    for(int i = 0; i < DirtyPrimitiveMapTest.size; i++) {
      final Random random = ThreadLocalRandom.current();
      final int randNumber = (int) Math.ceil(random.nextDouble() * DirtyPrimitiveMapTest.size);
